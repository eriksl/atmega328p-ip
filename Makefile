...
PROGRAM		=		main
OBJFILES	=		$(PROGRAM).o twi_master.o uart-telnet.o \
						application.o application-sensor.o application-twi.o \
						application-timer.o application-vfd.o \
